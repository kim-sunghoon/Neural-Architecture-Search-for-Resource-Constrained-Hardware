...
parser.add_argument(
    '-bn', '--batchnorm',
    action='store_true',
    help="include batch normalization in the architecture, default is false"
    )
parser.add_argument(
    '-a', '--augment',
    action='store_true',
...
parser.add_argument(
    '-ad', '--adapt',
    action='store_true',
    help="calculate macs, num_param and latency"
    )
parser.add_argument(
    '-m', '--multi-gpu',
    action='store_true',
...
def nas(device, dir='experiment'):
    ...
    for e in range(args.episodes):
        ...
        model, optimizer = child.get_model(
            ...
            multi_gpu=args.multi_gpu, do_bn=args.batchnorm)
