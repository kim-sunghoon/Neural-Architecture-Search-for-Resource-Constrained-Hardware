...
# 6 layer linear with stride and pooling 60000 LUT and 1000 throughput
# paras = [
#     {'filter_height': 5, 'filter_width': 5,
#      'stride_height': 1, 'stride_width': 1,
#      'num_filters': 48, 'pool_size': 2,
...
# 6 layer linear with stride and pooling 90000 LUT and 1000 throughput
# paras = [
#     {'filter_height': 1, 'filter_width': 3,
#      'stride_height': 1, 'stride_width': 1,
#      'num_filters': 48, 'pool_size': 2,
...
#      'weight_num_int_bits': 1, 'weight_num_frac_bits': 4},
#     {'filter_height': 5, 'filter_width': 1,
#      'stride_height': 3, 'stride_width': 2,
#      'num_filters': 48, 'pool_size': 1,
...
# paras = [
#     {'filter_height': 3, 'filter_width': 7, 'num_filters': 64, 'pool_size': 1},
